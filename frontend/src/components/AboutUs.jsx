    ...
    <div>
      ...
      <div className="about-us-container">
        ...
        <div className="left-section-second">
          <h2>Our Team</h2>
          <p>Hei olen Diaco, Sähkö Dominuksen perustaja ja pääsähköasentaja. Sähköalalla olen ollut mukana vuodesta 2015 ja valmistuin koulutuksestani kesällä 2018. Intohimoni sähkötekniikkaan on syvää ja olen sitoutunut aina asettamaan asiakkaiden tarpeet etusijalle.
